...
--
-- Ctrl+w Remap
map("n", "<C-A-D-y>", "<C-w>h", { desc = "Go to the left window", noremap = true })
map("n", "<C-A-D-o>", "<C-w>l", { desc = "Go to the right window", noremap = true })
map("n", "<C-A-D-u>", "<C-w>j", { desc = "Go to the down window", noremap = true })
map("n", "<C-A-D-i>", "<C-w>k", { desc = "Go to the up window", noremap = true })
...
map("n", "<C-A-D-'>", "<C-w>q", { desc = "Quit a window", noremap = true })
map("n", "<C-A-D-->", "<C-w>s", { desc = "Split window", noremap = true })
map("n", "<C-A-D-\\>", "<C-w>v", { desc = "Split window vertically", noremap = true })
