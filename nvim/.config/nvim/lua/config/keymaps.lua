...
map("n", "s", "<Plug>(easymotion-s2)", { remap = true })
map("v", "s", "<Plug>(easymotion-s2)", { remap = true })
map("n", "S", "<Plug>(easymotion-s)", { remap = true })

map("n", "H", "g^", { desc = "Go to the first character of the line" })
map("n", "L", "g$", { desc = "Go to the last character of the line" })
map("v", "H", "g^", { desc = "Go to the first character of the line" })
map("v", "L", "g$", { desc = "Go to the last character of the line" })
